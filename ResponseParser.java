...
/** The sole purpose of this class is to parse the response received from the API into the StockModel object.
 *
 *  @author Nishant Paul
 */
        ...
        try {
            ...
            if (input.readLine() != null) {
                while ((inputLine = input.readLine()) != null) {
                    ...
                    // Initiate a StockModel object to store the response data
